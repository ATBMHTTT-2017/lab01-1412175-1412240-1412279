...
-- duoc phep truy xuat du lieu thu chi
  grant create session to nv06,nv07;
  grant select on quantri.chitieu to nv06,nv07;
...
exec SA_USER_ADMIN.SET_USER_LABELS('NHANVIEN_OLS','NV07','KNC:L,QL,VL');
exec SA_USER_ADMIN.SET_USER_LABELS('NHANVIEN_OLS','NV10','KNC:L,QL,VL');
exec SA_USER_ADMIN.SET_USER_LABELS('NHANVIEN_OLS','NV13','KNC:L,QL,VL');
exec SA_USER_ADMIN.SET_USER_LABELS('NHANVIEN_OLS','NV16','KNC:L,QL,VL');
exec SA_USER_ADMIN.SET_USER_LABELS('NHANVIEN_OLS','NV19','KNC:L,QL,VL');
